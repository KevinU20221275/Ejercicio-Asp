...
namespace InventarioApp.Data
{
    ...
    {
        string connectionString = "Data Source=CDS1-PC29;Initial Catalog=Inventario;Integrated Security=True";
        ...
        public ProductModel? GetById(int id)
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                {
                    command.Connection = connection;
                    command.CommandText = @"SELECT Id, ProuctName, ProductDescription, ProductCategory, Stock, Price, ExpirationDate  FROM Product
                                            WHERE Id = @Id";
